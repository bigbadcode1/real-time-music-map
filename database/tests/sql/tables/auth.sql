...
INSERT INTO "Active Users" (id, song_id, geohash, expires_at) VALUES 
    ('01234567890123456789012345678901', '01234567890123456789CD', 'bcdefg12', NOW() + INTERVAL '1 hour'),
    ('01234567890123456789012345678902', '01234567890123456789CD', 'bcdefg12', NOW() + INTERVAL '1 hour');
