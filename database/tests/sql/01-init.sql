...
CREATE TABLE "Hotspots" (
  geohash VARCHAR(8) PRIMARY KEY NOT NULL CHECK(geohash ~ '^[0123456789bcdefghjkmnpqrstuvwxyz]{1,8}$'),
...
CREATE TABLE "Songs" (
  id TEXT PRIMARY KEY NOT NULL CHECK(id ~ '^[0-9A-Za-z]{22}$'),
...
CREATE TABLE "Active Users" (
  id TEXT PRIMARY KEY NOT NULL CHECK(id ~ '^[0-9A-Za-z]{22,32}$'),
