...
CALL upsert_active_user('user1', 'song1', 'geo45678', NOW() + INTERVAL '2 hour', 'valid_token_hash');
SELECT is(geohash, 'geo45678', 'Should update geohash') FROM test_active_users WHERE id = 'user1';

-- Test Case 2: Insert New User with Valid Token
CALL upsert_active_user('user2', 'song1', 'geo78911', NOW() + INTERVAL '1 hour', 'valid_token_hash');
...
SELECT throws_ok(
    $$CALL upsert_active_user('user3', 'song1', 'geo11111', NOW() + INTERVAL '1 hour', 'expired_token_hash');$$,
    '0A000',
...
SELECT throws_ok(
    $$CALL upsert_active_user('user1', 'song1', 'geo22222', NOW() + INTERVAL '1 hour', 'invalid_token_hash');$$,
    '28000',
