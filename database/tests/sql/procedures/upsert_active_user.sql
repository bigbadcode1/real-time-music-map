...
INSERT INTO "Hotspots" (geohash, count, last_updated) VALUES ('ge01234', 1, NOW());
INSERT INTO "Active Users" (id, name, song_id, geohash, expires_at) VALUES ('user123456789', 'rat', 'song11234908', 'ge01234', NOW() + INTERVAL '1 hour');
...
SELECT is(geohash, 'ge04567'::varchar, 'Should update geohash') FROM "Active Users" WHERE id = 'user123456789'::text; 
...
INSERT INTO "Active Users" (id, name, song_id, geohash, expires_at) VALUES ('user3333333333', 'fungus12', 'song11234908', 'ge01234', NOW() + INTERVAL '1 hour'); 
